...
export default function MapSection({
  ...
  addressLine1 = "C-5, Shyamkrupa Appts., Opp. Pawan Flate,",
  addressLine2 = "B/h Mothermilk Palace, Judges Bunglows Cross Road, Bodakdev, Ahmedabad - 380054",
            ...
            <div className={styles.infoList}>
              ...
              <div className={styles.infoRow}>
                ...
                <div className={styles.infoText}>
                  ...
                  <p className={styles.subText}>{addressLine1}</p>
              ...
              <div className={styles.infoRow}>
                ...
                <div className={styles.infoText}>
                  ...
                  <a href={`tel:${phone.replace(/\s/g, "")}`} className={styles.subText}>
                    {phone}
                  </a>
                </div>
              </div>
              ...
              <div className={styles.infoRow}>
                ...
                <div className={styles.infoText}>
                  <p className={styles.boldLabel}>Timings</p>
                  <p className={styles.subText}>10:00 AM - 5:00 PM</p>
                  <p className={styles.subText}>Saturday & Sunday: Closed</p>
                </div>
              </div>
